        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(26, 26, 26)
                                        .addComponent(s_date, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(38, 38, 38)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(363, 363, 363)
                        .addComponent(btn_payment, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                if(sdate1.compareTo(av_from1) >= 0 && edate1.compareTo(av_to1) <= 0 && edate1.compareTo(sdate1) >= 0) {
                    ...
                    if(cust_id != 0) {
                        ...
                        try {
                            ...
                            String q1 = "update house set vacancy = '" + no + "' where house_id = " + house_id;
                        ...
                        String sql = "insert into booking(customer_id, home_id, start_date, end_date, status) values (" + cust_id + "," + house_id + ",'" + sdf.format(s_date.getSelectedDate().getTime()) + "','" + sdf.format(end_date.getSelectedDate().getTime()) + "','Payment Pending')";
                        try {
